class User < ApplicationRecord
    ...
    has_many :articles, dependent: :destroy #creates one-to-many 'many' side of association with Article, AND destroys any Article objects when owner User is destroyed
